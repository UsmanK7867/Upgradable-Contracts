...
// File: contracts/Beacon Proxy/BeaconProxy.sol
...
// import "../CarRacingMarketplace/ERC1155.sol";
...
// }
contract MyToken is ERC721, Initializable {
    constructor() ERC721("MyToken", "MTK") {}
  string public name1;
    uint256 public vaLue;
...
contract MyToken1 is ERC721, Initializable {
    constructor() ERC721("MyToken", "MTK") {}
  string public name1;
    uint256 public vaLue;
    address public owner;
...
contract Factory {
    ...
    function create(string calldata _name, uint256 _vaLue, uint256 x) external returns (address) {
        BeaconProxy proxy = new BeaconProxy(address(beacon), 
            abi.encodeWithSelector(MyToken(tx.origin).initialize.selector, _name, _vaLue)
        );
